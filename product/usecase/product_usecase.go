...
import (
	model "github.com/goweb3/product"
	repos "github.com/goweb3/product/repository"
)
...
type ProductUsecase interface {
	...
	Fetch(offset int64, limit int64) ([]*model.Product, error)
}
...
func (uc *productUsecase) Fetch(offset int64, limit int64) ([]*model.Product, error) {
	if limit == 0 {
		limit = 10
	}
